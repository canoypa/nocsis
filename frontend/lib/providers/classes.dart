...
@riverpod
Future<ApiV1GroupsGroupIdClassesGet$Response> classes(
  Ref ref,
  String groupId,
) async {
  // 一日ごとに取得
  ...
  final response = await client.apiV1GroupsGroupIdClassesGet(
    groupId: groupId,
    from: from,
    to: to,
  );
  ...
  if (response.isSuccessful && response.body != null) {
    ...
    throw Exception('Classes fetch failed: ${response.statusCode}');
  }
}
